...
/**
 *## TbInputSearch - REMOVED in YiiBooster 5.0.
 *
 ...
 * "include(TbInputSearch.php): failed to open stream: No such file or directory" fatal.
 * It will be deleted in 5.1.
 *
 * @deprecated 5.0.0
 * @package booster.widgets.forms.inputs
 */
class TbInputSearch extends CInputWidget {

	public function init() {

		throw new CException('TbInputSearch was removed in YiiBooster 5.0. It emitted Bootstrap 2 markup and was not used by '
